...
// LESSON 78 @  7:10 - Create a 2nd WP Query to get Professors related to the search query
            ...
            if(get_post_type() == 'professor'){    
                array_push($results['professors'], array(         
                    ...
                    'image' => get_the_post_thumbnail_url(0, 'professorLandscape')
                                            ...
                                            // $results['professors'] = array_unique(a, b); // LESSON 78 @ 14:15: https://www.udemy.com/course/become-a-wordpress-developer-php-javascript/learn/lecture/7956672#overview
            
                                            // $results['professors'] = array_unique($results['professors'], SORT_REGULAR);     // L78 removes duplicate post results (Title, Body, Related Program Type)
 ...
 // ************************** MY ATTEMPTED SOLUTION TO THE THREE COLUMNS ******************************************           
        // if($professors->get_post_type() == 'professor'){        
        //     array_push($professorResults, array(        // professor Array
        //         'title' => get_the_title(),
        //         'permalink' => get_the_permalink(),
        //         'type' => get_post_type()
        //     ));
        ...
        // if($professors->get_post_type() == 'program'){
        //     array_push($programResults, array(          // program Array
        //         'title' => get_the_title(),
        //         'permalink' => get_the_permalink(),
        //         'type' => get_post_type()
        //     ));
        ...
        // if($professors->get_post_type() == 'event'){
        //     array_push($eventResults, array(            // events Array
        //         'title' => get_the_title(),
        //         'permalink' => get_the_permalink(),
        //         'type' => get_post_type()
        //     ));
