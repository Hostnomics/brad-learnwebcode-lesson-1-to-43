...
// Lesson 46 at 8:25 min REMOVE div class banner and ADD our functions.php pageBanner function
    pageBanner(); 
    ...
    if($relatedProfessors->have_posts()){  
       ...
       echo '<h2 class="headline headline--medium">' . get_the_title() . ' Professors</h2>';
            ...
            echo '<ul class="professor-cards">';    
                while($relatedProfessors->have_posts()){        // gets the data ready for each post, each time the code repeats itself
...
// ADDED IN LESSON 47 AT 10TH MINUTE: https://www.udemy.com/course/become-a-wordpress-developer-php-javascript/learn/lecture/7576532#overview
